<script>
import FancyHistory from "@/components/FancyHistory.fragment.vue";
import FancyInput from "@/components/FancyInput.fragment.vue";
...
<style>
    ...
    *, *::after, *::before {
    ...
    @media screen and (min-width: 860px) {
        ...
        .fancy-center .fancy-logo {
            margin-top: 0;
        }

        .fancy-center section {
